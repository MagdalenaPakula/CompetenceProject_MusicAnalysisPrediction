...
def search():
    ...
    r = requests.get("https://api.spotify.com/v1/search", data={"grant_type": "client_credentials"}, params={'type': 'track', 'q': title}, headers={'Authorization': 'Basic ZDQ1ODAyNTZiNGMxNGQ4Yjk1YmQ1MWViZGRhYTQ5MzI6Y2NlMjI0YTQ2OTMwNDU2ZjgyNzQwNmJkZmQ4YjAzNTk=', "Content-Type": "application/x-www-form-urlencoded"})
